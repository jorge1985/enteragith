...
<%@include file="jsp/header.jsp"%>
	...
	<%@include file="jsp/menubar.jsp"%>
		...
		<div class="small-10 medium-8 large-9 columns">
			<div id="content">
				<h1 class="main-title"><%=registry.getStringOfLanguage("content.title.recycle", language) %></h1>

				<div id="recycle_contents">
...
<!-- 					
					<div class="row left">
						<div class="large-12 columns">
							<a href="javascript:deleteContent('all', '0')" class="medium button right"><i class="fa fa-trash-o fa-lg"></i> Empty RecycleBin</a>
						</div>
					</div>
 -->					
					<div class="row left">
...
<form id="form_move_content" method="get" action="<%=basePath %>public/content.html" target="_blank">
	...
	<script src="<%=resPath%>js/recycle_content.js"></script>

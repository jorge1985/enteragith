...
<%@include file="jsp/header.jsp"%>
	...
	<%@include file="jsp/menubar.jsp"%>
		...
		<div class="small-10 medium-8 large-9 columns">
			<div id="content">
				<h1 class="main-title"><%=registry.getStringOfLanguage("log.title.access", language) %></h1>
					...
					<div class="row left">
						<div class="large-12 columns left">
							<div class="row">
								...
								<div class="large-1 columns">
									<a href="javascript:search()" id="btnsearch" class="button tiny"><%=registry.getStringOfLanguage("btn.search", language) %></a>
								</div>
								<div class="large-1 columns">
...
<table id="log_table" class="display" cellspacing="0" cellpadding="0" width="100%">
	...
	<script src="<%=resPath%>js/access_log.js"></script>

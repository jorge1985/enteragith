...
<%@include file="jsp/header.jsp"%>
	...
	<%@include file="jsp/menubar.jsp"%>
		...
		<div class="small-10 medium-8 large-9 columns">
			<div id="content">
				<h1 class="main-title"><%=registry.getStringOfLanguage("log.title.channel", language) %></h1>
...
<table id="log_table" class="display" cellspacing="0" cellpadding="0" width="100%">
    <thead>
        <tr>
            ...
            <th><%=registry.getStringOfLanguage("log.table.channel", language) %></th>
        </tr>
    </thead>
</table>
	...
	<script src="<%=resPath%>js/channel_log.js"></script>

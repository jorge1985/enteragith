/**
 * Opportunities automovil_adjudicado Results page. 
 */

$(document).ready(function() {

	$('#automovil_adjudicado').dataTable( {
		"processing": false,
		"responsive": true,
		"serverSide": true,
		"ajax": {
...
//		            }
	...
	$('#automovil_adjudicado').on('click', 'tr', function(){
		var sTable = $("#automovil_adjudicado").dataTable();

...
(function($){
	...
	// Plugin
	jQuery.fn.myeditor = function(option)
	{
		return this.each(function()
		{
			var $obj = $(this);

			var data = $obj.data('myeditor');
			if (!data)
			{
				$obj.data('myeditor', (data = new myeditor(this, option)));
			}
		});
	};
	...
	var myeditor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			modal_file: String() +
				'<div id="myeditor_modal_content">' +
				'<form id="myeditorUploadFileForm" method="post" action="" enctype="multipart/form-data">' +
					'<label>Name (optional)</label>' +
					'<input type="text" id="myeditor_filename" class="myeditor_input" />' +
					'<div style="margin-top: 7px;">' +
						'<input type="file" id="myeditor_file" name="file" />' +
					'</div>' +
				'</form><br>' +
				'</div>',
			...
			modal_image_edit: String() +
				...
				'<input id="myeditor_file_alt" class="myeditor_input" />' +
				'<label>' + RLANG.link + '</label>' +
				'<input id="myeditor_file_link" class="myeditor_input" />' +
				'<label>' + RLANG.image_position + '</label>' +
				'<select id="myeditor_form_image_align">' +
					'<option value="none">' + RLANG.none + '</option>' +
					'<option value="left">' + RLANG.left + '</option>' +
					'<option value="right">' + RLANG.right + '</option>' +
				'</select>' +
				'</div>' +
				'<div id="myeditor_modal_footer">' +
					'<a href="javascript:void(null);" id="myeditor_image_delete_btn" class="myeditor_modal_btn">' + RLANG._delete + '</a>&nbsp;&nbsp;&nbsp;' +
					'<a href="javascript:void(null);" class="myeditor_modal_btn myeditor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" name="save" class="myeditor_modal_btn" id="myeditorSaveBtn" value="' + RLANG.save + '" />' +
				'</div>',

			modal_image: String() +
				'<div id="myeditor_modal_content">' +
				'<div id="myeditor_tabs">' +
					'<a href="javascript:void(null);" class="myeditor_tabs_act">' + RLANG.upload + '</a>' +
					'<a href="javascript:void(null);">' + RLANG.choose + '</a>' +
					'<a href="javascript:void(null);">' + RLANG.link + '</a>' +
				'</div>' +
				'<form id="myeditorInsertImageForm" method="post" action="" enctype="multipart/form-data">' +
					'<div id="myeditor_tab1" class="myeditor_tab">' +
						'<input type="file" id="myeditor_file" name="file" />' +
					'</div>' +
					'<div id="myeditor_tab2" class="myeditor_tab" style="display: none;">' +
						'<div id="myeditor_image_box"></div>' +
					'</div>' +
				'</form>' +
				'<div id="myeditor_tab3" class="myeditor_tab" style="display: none;">' +
					'<label>' + RLANG.image_web_link + '</label>' +
					'<input type="text" name="myeditor_file_link" id="myeditor_file_link" class="myeditor_input"  />' +
				'</div>' +
				'</div>' +
				'<div id="myeditor_modal_footer">' +
					'<a href="javascript:void(null);" class="myeditor_modal_btn myeditor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" name="upload" class="myeditor_modal_btn" id="myeditor_upload_btn" value="' + RLANG.insert + '" />' +
				'</div>',

			modal_link: String() +
				'<div id="myeditor_modal_content">' +
				'<form id="myeditorInsertLinkForm" method="post" action="">' +
					'<div id="myeditor_tabs">' +
						'<a href="javascript:void(null);" class="myeditor_tabs_act">URL</a>' +
						'<a href="javascript:void(null);">Email</a>' +
						'<a href="javascript:void(null);">' + RLANG.anchor + '</a>' +
					'</div>' +
					'<input type="hidden" id="myeditor_tab_selected" value="1" />' +
					'<div class="myeditor_tab" id="myeditor_tab1">' +
						'<label>URL</label><input type="text" id="myeditor_link_url" class="myeditor_input"  />' +
						'<label>' + RLANG.text + '</label><input type="text" class="myeditor_input myeditor_link_text" id="myeditor_link_url_text" />' +
						'<label><input type="checkbox" id="myeditor_link_blank"> ' + RLANG.link_new_tab + '</label>' +
					'</div>' +
					'<div class="myeditor_tab" id="myeditor_tab2" style="display: none;">' +
						'<label>Email</label><input type="text" id="myeditor_link_mailto" class="myeditor_input" />' +
						'<label>' + RLANG.text + '</label><input type="text" class="myeditor_input myeditor_link_text" id="myeditor_link_mailto_text" />' +
					'</div>' +
					'<div class="myeditor_tab" id="myeditor_tab3" style="display: none;">' +
						'<label>' + RLANG.anchor + '</label><input type="text" class="myeditor_input" id="myeditor_link_anchor"  />' +
						'<label>' + RLANG.text + '</label><input type="text" class="myeditor_input myeditor_link_text" id="myeditor_link_anchor_text" />' +
					'</div>' +
				'</form>' +
				'</div>' +
				'<div id="myeditor_modal_footer">' +
					'<a href="javascript:void(null);" class="myeditor_modal_btn myeditor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" class="myeditor_modal_btn" id="myeditor_insert_link_btn" value="' + RLANG.insert + '" />' +
				'</div>',

			modal_table: String() +
				'<div id="myeditor_modal_content">' +
					'<label>' + RLANG.rows + '</label>' +
					'<input type="text" size="5" value="2" id="myeditor_table_rows" />' +
					'<label>' + RLANG.columns + '</label>' +
					'<input type="text" size="5" value="3" id="myeditor_table_columns" />' +
				'</div>' +
				'<div id="myeditor_modal_footer">' +
					'<a href="javascript:void(null);" class="myeditor_modal_btn myeditor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" name="upload" class="myeditor_modal_btn" id="myeditor_insert_table_btn" value="' + RLANG.insert + '" />' +
				'</div>',

			modal_video: String() +
				'<div id="myeditor_modal_content">' +
				'<form id="myeditorInsertVideoForm">' +
					'<label>' + RLANG.video_html_code + '</label>' +
					'<textarea id="myeditor_insert_video_area" style="width: 99%; height: 160px;"></textarea>' +
				'</form>' +
				'</div>'+
				'<div id="myeditor_modal_footer">' +
					'<a href="javascript:void(null);" class="myeditor_modal_btn myeditor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" class="myeditor_modal_btn" id="myeditor_insert_video_btn" value="' + RLANG.insert + '" />' +
				'</div>',
				...
				formatting:
				{
					...
					dropdown:
					{
						...
						blockquote:
						{
							title: RLANG.quote,
							exec: 'formatblock',
							className: 'myeditor_format_blockquote'
						},
						pre:
						{
							title: RLANG.code,
							exec: 'formatblock',
							className: 'myeditor_format_pre'
						},
						h1:
						{
							title: RLANG.header1,
							exec: 'formatblock',
							className: 'myeditor_format_h1'
						},
						h2:
						{
							title: RLANG.header2,
							exec: 'formatblock',
							className: 'myeditor_format_h2'
						},
						h3:
						{
							title: RLANG.header3,
							exec: 'formatblock',
							className: 'myeditor_format_h3'
						},
						h4:
						{
							title: RLANG.header4,
							exec: 'formatblock',
							className: 'myeditor_format_h4'
						}
					}
				},
				bold:
...
//				},
	...
	myeditor.prototype = {
		...
		init: function()
		{
			...
			function afterBuild()
			{
				...
				if (typeof this.opts.plugins === 'object')
				{
					...
					{
						if (typeof myeditorPlugins[s] !== 'undefined')
						{
							$.extend(this, myeditorPlugins[s]);

							if (typeof myeditorPlugins[s].init !== 'undefined')
							{
								this.init();
							}
						}
		...
		build: function(mobile, whendone)
		{
			...
			{
				// container
				this.$box = $('<div class="myeditor_box"></div>');

				// air box
				if (this.opts.air)
				{
					this.air = $('<div class="myeditor_air" style="display: none;"></div>');
				}
				...
				if (this.$el.get(0).tagName === 'TEXTAREA')
				{
					...
					{
						this.$content.addClass('myeditor_' + s);
					}, this));
				}
				else
				{
				...
				if (this.$editor)
				{
					this.$editor.addClass('myeditor_editor').attr('contenteditable', true).attr('dir', this.opts.direction);
				}
				...
				{
					this.$content.addClass('myeditor_editor_wym');
				}
		...
		destroy: function()
		{
			...
			else
			{
				...
				this.$box.remove();
				this.$editor.removeClass('myeditor_editor').removeClass('myeditor_editor_wym').attr('contenteditable', false).html(html).show();
			}
		...
		execCommand: function(cmd, param)
		{
			...
			try
			{
				...
				else if (cmd === 'JustifyLeft' || cmd === 'JustifyCenter' || cmd === 'JustifyRight' || cmd === 'JustifyFull')
				{
					...
					if (this.opts.iframe === false && $(parent).parents('.myeditor_editor').size() == 0)
					{
						return false;
					}
		...
		formatNewLine: function(e)
		{
			...
			if (parent.nodeName === 'DIV' && parent.className === 'myeditor_editor')
			{
		...
		buildToolbar: function()
		{
			...
			this.$toolbar = $('<ul>').addClass('myeditor_toolbar').addClass('button-group');
			...
			$.each(this.opts.buttons, $.proxy(function(i,key)
			{
				...
				if (key === '|')
				{
					this.$toolbar.append($('<li class="myeditor_separator"></li>'));
				}
		...
		{
			var button = $('<a href="javascript:void(null);" title="' + s.title + '" class="myeditor_btn_' + key + '"></a>');
			...
			{
				var dropdown = $('<div class="myeditor_dropdown" style="display: none;">');
		...
		buildDropdown: function(dropdown, obj)
		{
			$.each(obj, $.proxy(
				function (x, d)
				{
					...
					{
						drop_a = $('<a class="myeditor_separator_drop">');
					}
					else
					{
		...
		buildColorPicker: function(dropdown, key)
		{
			...
			for (var i = 0; i < len; ++i)
			{
				...
				var swatch = $('<a rel="' + color + '" href="javascript:void(null);" class="myeditor_color_link"></a>').css({ 'backgroundColor': color });
			...
			var elnone = $('<a href="javascript:void(null);" class="myeditor_color_none"></a>').html(RLANG.none);
		...
		{
			this.$toolbar.find('a.dropact').removeClass('myeditor_act').removeClass('dropact');
			$('.myeditor_dropdown').hide();
		},
		...
		getBtn: function(key)
		{
			...
			return $(this.$toolbar.find('a.myeditor_btn_' + key));
		},
		setBtnActive: function(key)
		{
			this.getBtn(key).addClass('myeditor_act');
		},
		setBtnInactive: function(key)
		{
			this.getBtn(key).removeClass('myeditor_act');
		},
		...
		{
			this.getBtn(key).addClass('myeditor_btn_' + classname);
		},
		removeBtnIcon: function(key, classname)
		{
			this.getBtn(key).removeClass('myeditor_btn_' + classname);
		},
		...
		addBtnSeparatorAfter: function(key)
		{
			...
			$btn.parent().after($('<li class="myeditor_separator"></li>'));
		},
		addBtnSeparatorBefore: function(key)
		{
			var $btn = this.getBtn(key);
			$btn.parent().before($('<li class="myeditor_separator"></li>'));
		},
		...
		setBtnRight: function(key)
		{
			...
			this.getBtn(key).parent().addClass('myeditor_btn_right');
		},
		setBtnLeft: function(key)
		{
			...
			this.getBtn(key).parent().removeClass('myeditor_btn_right');
		},
		...
		removeBtn: function(key, separator)
		{
			...
			$btn.parent().removeClass('myeditor_btn_right');
			$btn.remove();
		},
		...
		restoreSelection: function()
		{
			...
			{
				if (this.opts.iframe === false && $(this.savedSel[0]).closest('.myeditor_editor').size() == 0)
				{
					this.$editor.focus();
				}
				else
		...
		showTable: function()
		{
			...
			this.modalInit(RLANG.table, this.opts.modal_table, 300, $.proxy(function()
				{
					$('#myeditor_insert_table_btn').click($.proxy(this.insertTable, this));

					setTimeout(function()
					{
						$('#myeditor_table_rows').focus();
					}, 200);
		...
		{
			var rows = $('#myeditor_table_rows').val();
			var columns = $('#myeditor_table_columns').val();
		...
		showVideo: function()
		{
			...
			this.modalInit(RLANG.video, this.opts.modal_video, 600, $.proxy(function()
				{
					$('#myeditor_insert_video_btn').click($.proxy(this.insertVideo, this));

					setTimeout(function()
					{
						$('#myeditor_insert_video_area').focus();
					}, 200);
		...
		{
			var data = $('#myeditor_insert_video_area').val();
		...
		imageEdit: function(e)
		{
			...
			{
				$('#myeditor_file_alt').val($el.attr('alt'));
				$('#myeditor_image_edit_src').attr('href', $el.attr('src'));
				$('#myeditor_form_image_align').val($el.css('float'));

				if ($(parent).get(0).tagName === 'A')
				{
					$('#myeditor_file_link').val($(parent).attr('href'));
				}

				$('#myeditor_image_delete_btn').click($.proxy(function() { this.imageDelete($el); }, this));
				$('#myeditorSaveBtn').click($.proxy(function() { this.imageSave($el); }, this));
		...
		imageSave: function(el)
		{
			...
			$(el).attr('alt', $('#myeditor_file_alt').val());

			var floating = $('#myeditor_form_image_align').val();
			...
			// as link
			var link = $.trim($('#myeditor_file_link').val());
			if (link !== '')
			{
				if ($(parent).get(0).tagName !== 'A')
				{
			...
			var callback = $.proxy(function()
			{
					...
					$.getJSON(this.opts.imageGetJson, $.proxy(function(data) {
						...
						$.each(data, $.proxy(function(key, val)
						{
							...
							if (!$.isEmptyObject(folders) && typeof val.folder !== 'undefined')
							{
								...
								{
									folderclass = '.myeditorfolder' + folderkey;
								}
							}

							var img = $('<img src="' + val.thumb + '" class="myeditorfolder myeditorfolder' + folderkey + '" rel="' + val.image + '" title="' + thumbtitle + '" />');
							$('#myeditor_image_box').append(img);
						...
						if (!$.isEmptyObject(folders))
						{
							...
							{
								$('.myeditorfolder').hide();
								$('.myeditorfolder' + $(e.target).val()).show();
							}

							var select = $('<select id="myeditor_image_box_select">');
							$.each(folders, function(k,v)
							{
								select.append($('<option value="' + v + '">' + k + '</option>'));
							});

							$('#myeditor_image_box').before(select);
				...
				if (this.opts.imageUpload !== false)
				{
					...
					if (this.opts.uploadCrossDomain === false && this.isMobile() === false)
					{
						...
						if ($('#myeditor_file').size() !== 0)
						{
							$('#myeditor_file').dragupload(
							{
				...
				else
				{
					...
					if (this.opts.imageGetJson === false)
					{
						$('#myeditor_tabs').remove();
						$('#myeditor_tab3').show();
					}
					else
					{
						var tabs = $('#myeditor_tabs a');
						tabs.eq(0).remove();
						tabs.eq(1).addClass('myeditor_tabs_act');
						$('#myeditor_tab2').show();
					}
				}

				$('#myeditor_upload_btn').click($.proxy(this.imageUploadCallbackLink, this));

				if (this.opts.imageUpload === false && this.opts.imageGetJson === false)
				{
					setTimeout(function()
					{
						$('#myeditor_file_link').focus();
					}, 200);
		...
		{
			if ($('#myeditor_file_link').val() !== '')
			{
				var data = '<img src="' + $('#myeditor_file_link').val() + '" />';
		...
		showLink: function()
		{
			...
			var callback = $.proxy(function()
			{
				...
				if (url.search('mailto:') === 0)
				{
					...
					$('#myeditor_tab_selected').val(2);
					$('#myeditor_link_mailto').val(url.replace('mailto:', ''));
				}
				else if (turl.search(/^#/gi) === 0)
				{
					this.setModalTab(3);

					$('#myeditor_tab_selected').val(3);
					$('#myeditor_link_anchor').val(turl.replace(/^#/gi, ''));
				}
				else
				{
					$('#myeditor_link_url').val(turl);
				}

				if (target === '_blank')
				{
					$('#myeditor_link_blank').attr('checked', true);
				}

				$('#myeditor_insert_link_btn').click($.proxy(this.insertLink, this));

				setTimeout(function()
				{
					$('#myeditor_link_url').focus();
				}, 200);
		...
		insertLink: function()
		{
			var tab_selected = $('#myeditor_tab_selected').val();
			var link = '', text = '', target = '';

			if (tab_selected === '1') // url
			{
				link = $('#myeditor_link_url').val();
				text = $('#myeditor_link_url_text').val();

				if ($('#myeditor_link_blank').attr('checked'))
				{
			...
			{
				link = 'mailto:' + $('#myeditor_link_mailto').val();
				text = $('#myeditor_link_mailto_text').val();
			}
			else if (tab_selected === '3') // anchor
			{
				link = '#' + $('#myeditor_link_anchor').val();
				text = $('#myeditor_link_anchor_text').val();
			}
		...
		fileUploadCallback: function(json)
		{
			...
			if (json !== false)
			{
				var text = $('#myeditor_filename').val();
		...
		{
			// modal overlay
			if ($('#myeditor_modal_overlay').size() === 0)
			{
				this.overlay = $('<div id="myeditor_modal_overlay" style="display: none;"></div>');
				$('body').prepend(this.overlay);
			}

			if (this.opts.overlay)
			{
				$('#myeditor_modal_overlay').show();
				$('#myeditor_modal_overlay').click($.proxy(this.modalClose, this));
			}

			if ($('#myeditor_modal').size() === 0)
			{
				this.modal = $('<div id="myeditor_modal" style="display: none;"><div id="myeditor_modal_close">&times;</div><div id="myeditor_modal_header"></div><div id="myeditor_modal_inner"></div></div>');
				$('body').append(this.modal);
			}

			$('#myeditor_modal_close').click($.proxy(this.modalClose, this));
			...
			{
				$('#myeditor_modal_inner').empty().append($(content).html());
			}
			else
			{
				$('#myeditor_modal_inner').empty().append(content);
			}

			$('#myeditor_modal_header').html(title);

			// draggable
			if (typeof $.fn.draggable !== 'undefined')
			{
				$('#myeditor_modal').draggable({ handle: '#myeditor_modal_header' });
				$('#myeditor_modal_header').css('cursor', 'move');
			}

			// tabs
			if ($('#myeditor_tabs').size() !== 0)
			{
				var that = this;
				$('#myeditor_tabs a').each(function(i,s)
				{
					i++;
					$(s).click(function()
					{
						$('#myeditor_tabs a').removeClass('myeditor_tabs_act');
						$(this).addClass('myeditor_tabs_act');
						$('.myeditor_tab').hide();
						$('#myeditor_tab' + i).show();
						$('#myeditor_tab_selected').val(i);

						if (that.isMobile() === false)
						{
							var height = $('#myeditor_modal').outerHeight();
							$('#myeditor_modal').css('margin-top', '-' + (height+10)/2 + 'px');
						}
					});
				});
			}

			$('#myeditor_modal .myeditor_btn_modal_close').click($.proxy(this.modalClose, this));

			if (this.isMobile() === false)
			{
				$('#myeditor_modal').css({ position: 'fixed', top: '-2000px', left: '50%', width: width + 'px', marginLeft: '-' + (width+60)/2 + 'px' }).show();
			...
			{
				$('#myeditor_modal').css({ position: 'fixed', width: '100%', height: '100%', top: '0', left: '0', margin: '0', minHeight: '300px' }).show();
			}
			...
			if (this.isMobile() === false)
			{
				...
				{
					var height = $('#myeditor_modal').outerHeight();
					$('#myeditor_modal').css({ top: '50%', height: 'auto', minHeight: 'auto', marginTop: '-' + (height+10)/2 + 'px' });
		...
		modalClose: function()
		{
			$('#myeditor_modal_close').unbind('click', this.modalClose);
			$('#myeditor_modal').fadeOut('fast', $.proxy(function()
			{
				$('#myeditor_modal_inner').html('');

				if (this.opts.overlay)
				{
					$('#myeditor_modal_overlay').hide();
					$('#myeditor_modal_overlay').unbind('click', this.modalClose);
				}
		...
		setModalTab: function(num)
		{
			$('.myeditor_tab').hide();
			var tabs = $('#myeditor_tabs a');
			tabs.removeClass('myeditor_tabs_act');
			tabs.eq(num-1).addClass('myeditor_tabs_act');
			$('#myeditor_tab' + num).show();
		},
		...
		uploadForm : function(f, name)
		{
			...
			{
				var formId = 'myeditorUploadForm' + this.id;
				var fileId = 'myeditorUploadFile' + this.id;
	...
	{
		return this.data('myeditor');
	};

	$.fn.getEditor = function()
	{
		return this.data('myeditor').$editor;
	};

	$.fn.getCode = function()
	{
		return $.trim(this.data('myeditor').getCode());
	};

	$.fn.getText = function()
	{
		return this.data('myeditor').$editor.text();
	};

	$.fn.getSelected = function()
	{
		return this.data('myeditor').getSelectedHtml();
	};

	$.fn.setCode = function(html)
	{
		this.data('myeditor').setCode(html);
	};

	$.fn.insertHtml = function(html)
	{
		this.data('myeditor').insertHtml(html);
	};
	...
	$.fn.destroyEditor = function()
	{
		this.each(function()
		{
			if (typeof $(this).data('myeditor') != 'undefined')
			{
				$(this).data('myeditor').destroy();
				$(this).removeData('myeditor');
			}
		});
	};
	...
	{
		this.data('myeditor').$editor.focus();
	};
	
	$.fn.saveSelection = function(){
		this.data('myeditor').saveSelection();
	};
	
	$.fn.insertImage = function(name, key)
	{
		this.data('myeditor').restoreSelection();
		html = '<div><img src="' + key + '" style="width:100%; height:100%;" /></div>';
		this.data('myeditor').execCommand('inserthtml', html);
		this.data('myeditor').observeImages();
	};

	$.fn.insertArticle = function(video, image)
	{
		this.data('myeditor').restoreSelection();
		html = '<div><img video="'+video+'" src="' + image + '" style="width:100%; height:100%;" /></div>';
		this.data('myeditor').execCommand('inserthtml', html);
		this.data('myeditor').observeImages();
	};
...
//				'<source src="'+key+'">'+
//				'</video>'+
//			  	'<iframe style="width: 320px; height: 240px;" src="' + key + '" frameborder="0" autoplay="" allowfullscreen></iframe>'+
			   '</div>';
		this.data('myeditor').execCommand('inserthtml', html);
		this.data('myeditor').syncCode();
	};
	
	$.fn.insertFile = function(name, key)
	{
		this.data('myeditor').restoreSelection();
		html = '<div><a href="' + key + '">'+name+'</a></div>';
		this.data('myeditor').execCommand('inserthtml', html);
		this.data('myeditor').syncCode();
	};

	$.fn.insertForum = function(url, size)
	{
		this.data('myeditor').restoreSelection();
		html = '<div>' +
			  	'<iframe style="'+size+'" src="' + url + '" frameborder="0" scrolling="auto"></iframe>'+
			   '</div>';
		this.data('myeditor').execCommand('inserthtml', html);
		this.data('myeditor').syncCode();
	};
	...
	{
		this.data('myeditor').execCommand(cmd, param);
	};
...
(function($){
	...
	Construct.prototype = {
		init: function()
		{
			...
			{
				this.droparea = $('<div class="myeditor_droparea"></div>');
				this.dropareabox = $('<div class="myeditor_dropareabox">' + this.opts.text + '</div>');
				this.dropalternative = $('<div class="myeditor_dropalternative">' + this.opts.atext + '</div>');

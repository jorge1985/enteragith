...
<%
	...
	if (user_body!=null && user_body.getUserId()!=0){
		...
		sessionid_body=DigestUtils.md5Hex(userid_body+Constants.SESSION_HASH);
	}
%>
...
<div class="row">
	...
	<section class=" large-15 medium-15 small-20 columns" id="content-wrapper">
		<div class="row" data-equalizer>
			<div class="large-8 medium-8 small-16 columns video-slider-wrapper" data-equalizer-watch>
...
%>					
			...
			<div class="large-4 medium-4 small-16 columns" id="temas" data-equalizer-watch>
			...
			<div class="large-4 medium-4 small-16 columns" id="home-side-banners" data-equalizer-watch>
				${banner_sidebar }
			</div>
		</div>		
...
<input type="hidden" id="content_video_path_<%=video_index%>" value="${item.video }">
<input type="hidden" id="content_image_path_<%=video_index%>" value="${item.image }">
</div>
<% video_index++; %>
</c:forEach>		
<%
...
<script src="<%=resPath%>bower_components/slick-carousel/slick/slick.min.js"></script>

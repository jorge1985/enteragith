...
<%
	...
	String imagen3 = (String) request.getAttribute("Imagen3");
	String imagen4 = (String) request.getAttribute("Imagen4");
	String imagen5 = (String) request.getAttribute("Imagen5");
...
<div class="row">
	...
	<section class=" large-15 medium-15 small-20 columns"
		...
		<div id="amazingslider-wrapper-1" style="display:block;position:relative;max-width:473px;margin:0px auto 108px;">
        <div id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
            <ul class="amazingslider-slides" style="display:none;">
                <li><img src="<%=resPath%>videocarrucel/images/1vU7XqToZso-tn.jpg" />
                <%=video1%>" 
                </li>
                <li><img src="<%=imagen2%>" />
                <video preload="none" src="<%=video2%>" ></video>
                </li>
                <li><img src="<%=imagen3%>" />
                <video preload="none" src="<%=video3%>" ></video>
                </li>
                <li><img src="<%=imagen4%>" />
                <video preload="none" src="<%=video4%>" ></video>
                </li>
                <li><img src="<%=imagen5%>" />
                <video preload="none" src="<%=video5%>" ></video>
                </li>
            </ul>
            <ul class="amazingslider-thumbnails" style="display:none;">
                <li><img src="<%=resPath%>videocarrucel/images/1vU7XqToZso.jpg" /></li>
                <li><img src="<%=imagen2%>" /></li>
                <li><img src="<%=imagen3%>" /></li>
                <li><img src="<%=imagen4%>" /></li>
                <li><img src="<%=imagen5%>" /></li>
            </ul>
        </div>
    </div>
    </div>
...
<script src="<%=resPath%>videocarrucel/sliderengine/jquery.js"></script>
 <script src="<%=resPath%>videocarrucel/sliderengine/amazingslider.js"></script>
 <link rel="stylesheet" type="text/css" href="<%=resPath%>videocarrucel/sliderengine/amazingslider-1.css">
 <script src="<%=resPath%>videocarrucel/sliderengine/initslider-1.js"></script>

...
<table id="automovil_adjudicado" class="display" cellspacing="0" cellpadding="0" width="100%">
	<thead>
	<tr>
...
<script type="text/javascript" src="<%=resPath_automovil_result%>js/opp_results_automovil_adjudicado.js"></script>
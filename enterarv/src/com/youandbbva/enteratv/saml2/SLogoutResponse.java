 ...
 */
public class SLogoutResponse {

    protected LogoutResponse response;

    protected Assertion assertion;

    /*private*/ SLogoutResponse() {

    }

    public static SLogoutResponse createNew() {
        return new SLogoutResponse();
    }
    ...
    public void handleRequest(HttpServletRequest req) {
        ...
        response = (LogoutResponse)baseMessageContext.getInboundSAMLMessage();
